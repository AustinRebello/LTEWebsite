...
class PresidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create president" do
    assert_difference("President.count") do
      post presidents_url, params: { president: { date: @president.date, state: @president.state } }
    end
  ...
  test "should update president" do
    patch president_url(@president), params: { president: { date: @president.date, state: @president.state } }
